...
def validate_color(major_color, minor_color):
    if major_color not in MAJOR_COLORS:
        raise ValueError('Major color out of range')
    if minor_color not in MINOR_COLORS:
        raise ValueError('Minor color out of range')
...
def get_pair_number_from_color(major_color, minor_color):
    validate_color(major_color, minor_color)
